...
WORKING_DMTCP_COMMIT="${
  WORKING_DMTCP_COMMIT:-
  6896e12276a9fe449edb0cf206203ce01b19efe6
}"
...
BASELINE_REPETITIONS_TEXT="${
  BASELINE_REPETITIONS_TEXT:-
  ${REPETITIONS_TEXT:-1 2 3}
}"
...
#
# skip:
#   Reuse the directory only when total_seconds.txt is present.
#
# error:
